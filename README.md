...
* TLS/DTLS ServerHello extension types `0`, `11`, and `35` are omitted from
  server fingerprints because they can vary between initial and resumed
  handshakes without changing the selected TLS stack behavior.
